            ...
            <div class=" col-md-5 mb-3"><br>
                <div class="card border shadow-lg p-2">
                    ...
                    if($bill['status'] == 'Not Paid'){
                        ?>
                    <h2 class="align-items-center text-center">Online Payment <?php echo $uid?></h2>
                    
                    <div class="card-body">
                        <p>*Fill required information of the person who is paying.</p>
                        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]). '?billmonth=' . $text;?>" method="POST"
                            id="payment-form">
                            <div class="form-group">
                                <label>Bill Owner Name</label>
                                <input type="hidden" class="form-control" name="user_id" value="<?php echo $uid; ?>">
                            ...
                            <div class="form-group">
                                ...
                                <input type="hidden" class="form-control" name="accountNum" value="<?php echo $accountNum; ?>"
                                    >
                            </div>
                    ...
                    <?php
                        ...
                        else if($bill['status'] == 'Partly Paid'){
                        ?>
